package com.example.android.clone2.adapters;
...
import com.example.android.clone2.models.HomeItemModel;
import com.example.android.clone2.models.MainItemAppModel;
import com.example.android.clone2.models.PopularItemAppModel;
        ...
        if (homeItemModel != null) {
            switch (homeItemModel.getType()) {
                ...
                case "normal":
                    ...
                    com.example.android.clone2.adapters.MainItemAppAdapter mainItemAppAdapter = new com.example.android.clone2.adapters.MainItemAppAdapter(list);
